    ...
    <div className={classes.secondaryinput}>
        ...
        >
          ...
          {(() => {
            ...
            {
            for (const [key, value] of Object.entries(props.comboBoxFields)) {
            ...
            {
            for(var i = 0; i < props.comboBoxFields.length; i++) {
              var name_selected = props.comboBoxFields[i];
              ...
              options.push(<option value={props.comboBoxFields.length[i]}>{final_name_selected}</option>);
            }
            }
            return options;
          })()}
